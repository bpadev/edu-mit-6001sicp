; Introduction
; Computational process - abstract beings that inhabit computers, as they evolve, processes manipulate other abstract things called data.
...
; The contrast between function and procedure is a reflection of the general distinction between describing properties of things and describing how to do things. (declarative knowledge vs. imperative knowledge).
...
; Lexical scoping, dictates that free variables in a procedure are taken to refer to bindings made by enclosing procedure defintions, that is, they are looked up in the environment in which the procedure was defined.
